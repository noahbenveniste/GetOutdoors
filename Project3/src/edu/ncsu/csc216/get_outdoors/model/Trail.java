...
public class Trail extends Observable implements Comparable<Trail> {
	 ...
	 * 
	 * @param trailId the Trail's unique identifer. Within the context of GetOutdoors, this field is generated by TrailList
	 * @param trailName the Trail's name; used to sort/compare Trails
	 ...
	 * @param difficulty the Trail's level of difficulty
	 */
	public Trail(String trailId, String trailName, SortedArrayList<Activity> activities, boolean closedForMaintenance, 
		...
		//Checking "trailName" param and setting Trail ID if valid.
		if (trailName == null) {
	 ...
	 * Observers of Trail are notified of the change if this method is called subsequently to construction.
	 * 
	 * @param snowChange the amount of snow to add to the Trail
	 * @return the new total amount of snow on the Trail
	 */
	public double addSnow(double snowChange) {
		//Generate the new amount of snow
		double sum = snow + snowChange;
	...
	public int compareTo(Trail t) {
		return getTrailName().compareTo(t.getTrailName());
	}
	...
	public boolean equals(Object obj) {
		if (obj instanceof Trail) {
			Trail t = (Trail) obj;
			return trailName.equals(t.getTrailName());
		} else {
			return false;
		}
	}
